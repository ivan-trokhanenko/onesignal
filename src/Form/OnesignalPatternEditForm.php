...
class OnesignalPatternEditForm extends EntityForm {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['pattern_container'] = [
      '#type' => 'container',
      '#prefix' => '<div id="onesignal-pattern">',
      '#suffix' => '</div>',
    ];
    ...
    if ($this->entity->getType()) {
      ...
      $form['pattern_container']['summary'] = [
        '#type' => 'textfield',
...
//      ];
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => 'Drupal\onesignal\Entity\OnesignalPattern::load', // todo. fix to onesignal
      ],
    ];
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('OneSignal pattern %label saved.', [
